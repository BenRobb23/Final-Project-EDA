...
<!-- DH: I looked at HotOnesSaucesEDA.Rmd before this one.  Many similar issues, so I'm only skimming and pointing out a few additional things. -->
...
```{r}
colnames(dataf)
## DH: Did you mean `dataf`?  `data` is a function
